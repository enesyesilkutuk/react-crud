...
const EmployeeContextProvider = ({children}) => {
    ...
    return <EmployeeContext.Provider value={{sortedEmployees, addNewEmployee, deleteEmployee, updateEmployee, addAlert, setAddAlert, updateAlert, setUpdateAlert, deleteAlert, setDeleteAlert}}>{children}</EmployeeContext.Provider>
